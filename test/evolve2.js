...
describe('evolve2', function() {
  it('creates a new object by evolving the `object` according to the `transformation` function', function() {
    ...
    eq(R.evolve2(transf, object), expected);
  });
  ...
  it('is not destructive', function() {
    ...
    R.evolve2(transf, object);
    eq(object, expected);
  });

  it('is recursive', function() {
    var transf   = {second: R.add(-1), third: R.add(1)};
  ...
  it('ignores transformations if the input value is not Array and Object', function() {
    ...
    eq(R.evolve2(transf, 42), 42);
    eq(R.evolve2(transf, undefined), undefined);
    eq(R.evolve2(transf, null), null);
    eq(R.evolve2(transf, ''), '');
  });
});
